 ...
 */
public class MrUniformGeneratorCtrl {

    private MrUniformGeneratorContainer mUniformGenerators;
    private MrUniformGeneratorView mView;
    private int mVisibility;

    public MrUniformGeneratorCtrl(MrUniformGeneratorContainer uniforms) {
        mUniformGenerators = uniforms;
        mView = new MrUniformGeneratorView(this);
        mVisibility = 0;
    }

    public MrUniformGeneratorView getView() {
        return mView;
    }
