...
package mr.robotto.engine.components.data.mesh;

import mr.robotto.engine.commons.MrDataType;

/**
 * Class used to determine position and order of {@link mr.robotto.engine.components.data.shader.MrAttribute} data stored inside a {@link MrBuffer}
 */
public class MrBufferKey {
     ...
     * @return See {@link mr.robotto.engine.components.data.shader.MrAttribute} to see returned values
     */
