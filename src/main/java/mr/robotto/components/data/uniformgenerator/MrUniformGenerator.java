...
public abstract class MrUniformGenerator {
    ...
    public static final String GENERATOR_MATERIAL_DIFFUSE_INTENSITY = "Generator_Diffuse_Intensity";
    public static final String GENERATOR_MATERIAL_SPECULAR_COLOR = "Generator_Specular_Color";
